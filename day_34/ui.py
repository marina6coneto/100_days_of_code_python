...
class QuizInterface:
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.true_image = PhotoImage(file='day_34/images/true.png')
        ...
        self.false_image = PhotoImage(file='day_34/images/false.png')
    ...
    def get_next_question(self):
        ...
        if self.quiz.still_has_questions():
            self.score_label.config(text=f'Socre: {self.quiz.score}')
